...
function MainContent({ onAuthClick, onCartClick, onCheckoutClick, currentPage, setCurrentPage }: any) {
    ...
    <PayPalScriptProvider options={initialOptions}>
      <AppProvider>
        <div className="font-sans text-gray-900 bg-white">
          ...
          <CartDrawer isOpen={isCartOpen} onClose={() => setIsCartOpen(false)} onCheckoutClick={() => setIsCheckoutOpen(true)} />
